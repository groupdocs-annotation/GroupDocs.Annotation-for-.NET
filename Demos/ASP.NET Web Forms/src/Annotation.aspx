<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Annotation.aspx.cs" Inherits="GroupDocs.Annotation.AspNetWebForms.Annotation" %>

<%
    GroupDocs.Annotation.AspNetWebForms.Products.Common.Config.GlobalConfiguration config = new GroupDocs.Annotation.AspNetWebForms.Products.Common.Config.GlobalConfiguration();
%>
<!DOCTYPE html>
<html>
<head>
